...
const S = {
  corner: { t: 1, p: [{ x: 304.6, y: 127, w: 54.6, h: 54.6, rx: 16.7, op: 1 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }] },
  cover: { t: 0, p: [{ x: 132, y: 132, w: 248, h: 248, rx: 58, op: 1 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }] },
  kanban: { t: 0, p: [{ x: 96, y: 104, w: 140, h: 304, rx: 24, op: 1 }, { x: 276, y: 104, w: 140, h: 200, rx: 24, op: 1 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }] },
  list: { t: 0, p: [{ x: 156, y: 132, w: 276, h: 32, rx: 16, op: 1 }, { x: 156, y: 240, w: 276, h: 32, rx: 16, op: 1 }, { x: 156, y: 348, w: 276, h: 32, rx: 16, op: 1 }, { x: 80, y: 130, w: 36, h: 36, rx: 10, op: 1 }, { x: 80, y: 238, w: 36, h: 36, rx: 10, op: 1 }, { x: 80, y: 346, w: 36, h: 36, rx: 10, op: 1 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }] },
  timeline: { t: 0, p: [{ x: 200, y: 124, w: 224, h: 32, rx: 16, op: 1 }, { x: 200, y: 240, w: 172, h: 32, rx: 16, op: 1 }, { x: 200, y: 356, w: 200, h: 32, rx: 16, op: 1 }, { x: 112, y: 112, w: 56, h: 56, rx: 28, op: 1 }, { x: 112, y: 228, w: 56, h: 56, rx: 28, op: 1 }, { x: 112, y: 344, w: 56, h: 56, rx: 28, op: 1 }, { x: 124, y: 120, w: 32, h: 272, rx: 16, op: 1 }] },
  gantt: { t: 0, p: [{ x: 80, y: 112, w: 200, h: 48, rx: 26, op: 1 }, { x: 168, y: 196, w: 210, h: 48, rx: 26, op: 1 }, { x: 120, y: 280, w: 170, h: 48, rx: 26, op: 1 }, { x: 236, y: 364, w: 184, h: 48, rx: 26, op: 1 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }] },
  matrix: { t: 0, p: [{ x: 96, y: 96, w: 140, h: 140, rx: 20, op: 1 }, { x: 276, y: 96, w: 140, h: 140, rx: 20, op: 1 }, { x: 96, y: 276, w: 140, h: 140, rx: 20, op: 1 }, { x: 276, y: 276, w: 140, h: 140, rx: 20, op: 1 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }, { x: 246, y: 246, w: 20, h: 20, rx: 10, op: 0 }] },
}
...
const VIEWS = ['corner', 'kanban', 'list', 'timeline', 'gantt', 'matrix']

const seg = (a, b, ra, rb, dur) => ({ a, b, ra, rb, dur })
const INTRO = [seg(S.corner, S.corner, 0, 0, 800), seg(S.corner, S.cover, 0, 0, 600), seg(S.cover, S.cover, 0, 0, 250)]
const LOOP = []
VIEWS.forEach((v) => {
