...
// Members offered for @-mentions — see buildMentionItems for how a member's
// inserted text (`label`) is picked.
const mentionItems = computed(() =>
  buildMentionItems(bv.membersList, bv.gitlabMembersList, bv.gitlabMembersMap),
)
