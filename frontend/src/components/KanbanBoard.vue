...
import { matchesAssignee, matchesAuthor, boardGitlabAuthors } from '@/utils/boardFilters'
...
const filteredTasks = computed(() => {
  ...
  if (filters.assignees.length) arr = arr.filter((t) => matchesAssignee(t, filters.assignees))
  if (filters.authors.length)
    arr = arr.filter((t) => matchesAuthor(t, filters.authors, glLoginByUserId.value))
