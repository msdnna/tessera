...
export const WHATS_NEW = [
  {
    ...
    items: [
      'Внизу боковой панели появилась кнопка «Помощь» со знаком вопроса: в ней «Обучение» и новый «Справочный центр». Справка открывается окном поверх доски — с навигацией по разделам, поиском по всем статьям и оглавлением, — так что читать её можно, не бросая работу.',
      'Кнопка «?» в шапке и в окне задачи открывает статью именно про тот экран, который сейчас перед вами. Статьи справки находятся и через общий поиск.',
      'В статьях есть скриншоты интерфейса, и в тёмной теме они тоже тёмные.',
    ],
  },
  {
    version: '0.173.0',
    date: '2026-08-20',
    title: 'Обучение показывает перетаскивание',
    items: [
      'В путеводителе Get Started появились шаги «мышью»: перенос карточки между колонками доски и перенос проекта в группу дерева, а между ними — создание группы проектов. Шаг закрывается, когда элемент действительно переехал.',
      'Во время перетаскивания подсказка и затемнение гаснут, чтобы стрелка не мешала целиться.',
    ],
  },
  {
    version: '0.172.0',
