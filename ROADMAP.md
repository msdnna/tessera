...
**Прочий бэклог видов:**
- **Виртуализация строк тела в таймлайне/Ганте/матрице на web** (Android сделан) — корень просадки на
  200+ задачах; та же причина тормозила анимацию сворачивания (убрана) и зум в часах (тики уже оконные,
  но сами строки/бары/гридлайны рендерятся все). Пользователь: «вопрос производительности решаем отдельно».
