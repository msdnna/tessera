...
- **Заметки, документы и личные напоминания**: быстрые заметки, совместные
  Markdown-страницы (модуль «Документы» — блочный редактор, версии, обсуждения по
  абзацам, согласование, импорт из Word) и напоминания с расписанием.
- **Конференции**: аудио- и видеозвонки встроены в трекер — созвоны без перехода в
  мессенджер, привязка встречи к задаче, демонстрация экрана, серверная запись, чат и
  модерация. Доступны в вебе и в мобильных клиентах (на базе LiveKit).
