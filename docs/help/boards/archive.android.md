...
Открыв архив, вы не уходите на отдельный экран. Это **область** той же доски: те же колонки, та же группировка, те же фильтры — но показаны архивные задачи вместо живых. В [панели доски](/help/board-composer) появляется янтарный чип **«Архив»**; крестик на нём возвращает к обычной доске.
