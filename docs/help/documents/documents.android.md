...
Связи документа с задачами с телефона **не видны вовсе** — ни в читалке, ни в окне задачи (вкладка «Связи» там про связи между задачами). Подробнее — [Документы задачи](/help/task-documents).
