...
Неразрешённый конфликт видно сразу в трёх местах: оранжевая метка **«Конфликт»** на карточке задачи, счётчик на кнопке «Синхронизировать» и на иконке «Интеграции» в шапке боковой панели, и пункт **«Конфликты»** в меню рядом с кнопкой синхронизации (он активен, только когда есть что разрешать).
