...
Строка связи ведёт себя как ссылка: клик открывает связанную задачу. У выполненной задачи название зачёркнуто, так что видно, снята блокировка или нет. Крестик справа связь снимает — после подтверждения «Убрать связь?».
