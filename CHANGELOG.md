...
### [0.83.1] — 2026-08-03
- **fix(gitlab): миграция 0047 — самовосстановление колонок 0046.** На части окружений
  схема была заранее поднята до версии 46 сторонней (вне-репо) миграцией, из-за чего
  golang-migrate счёл 0046 применённой и НЕ создал колонки → каждый чтение
