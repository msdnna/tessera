...
### [0.145.6] — 2026-08-03
- **Фикс (доработка) формы комментария в тёмной теме.** Sticky-подложка
  `.comment-add` красила себя `background: var(--t-surface)`, что давало видимую
  полосу другого оттенка над формой и по нижним углам (corners) в тёмной теме.
  Фон убран — подложка наследует поверхность модального окна.
...
- **Форма комментария в модалке задачи больше не выбивается из тёмной темы.**
  ...
  Вариант редактора для описания задачи не тронут.
