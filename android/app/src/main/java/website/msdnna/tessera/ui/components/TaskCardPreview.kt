...
private val sampleTags = listOf(
    Tag(id = "t1", name = "ЕПВВ", color = "#18a058"),
...
private val parentTask = Task(
    id = "1", columnId = "c", title = "Развернуть внешние сервисы в ЗР с помощью Ansible",
...
private fun sampleState() = BoardUiState(
    loading = false,
    columns = listOf(BoardColumn(id = "c", name = "В процессе")),
